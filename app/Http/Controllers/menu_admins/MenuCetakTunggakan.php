...
class MenuCetakTunggakan extends Controller
{
    public function index(Request $request)
    {
        ...
        $tagihans = CekTagihan::join('pelanggans', 'pelanggans.id_pelanggan', '=', 'cek_tagihans.id_pelanggan')
            ...
            ->whereRaw('pelanggans.alamat_pelanggan LIKE ?', ['%' . $wilayah . '%'])
        ...
        if ($wilayah) {
            ...
            return redirect()->route('cetak-tunggakan')->with(['list_tunggakan' => $list_tunggakan, 'wilayah' => $wilayah, 'currentMonthYearIndo' => $currentMonthYearIndo, 'monthOnlyAgo' => $monthOnlyAgo]);
        }

        return view('content.menu-admin.menu-cetak-tunggakan');
    }
}
